...
public class BookingPresenter implements ViewObserver {
    ...
    public void updateUIShowReservationChange(Reservation reservation) {
    ...
    public void onChangeReservationTable(int oldReservation, Date reservationDate, int tableNo, String name) {
        try {
            Reservation reservationNew = model.changeReservationTable(oldReservation, reservationDate, tableNo, name);
            updateUIShowReservationChange(reservationNew);


        } catch (RuntimeException e) {

            updateUIShowReservationChange(null);
